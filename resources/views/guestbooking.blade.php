            ...
            <div class="text-center mb-4">
                ...
                @if(Session::has('id'))
                    <div class="alert alert-success alert-custom bg-success bg-opacity-25 border-success text-white mt-3">
                        <i class="fas fa-user-check me-2"></i>Welcome back, <strong>{{ Session::get('name') }}</strong>!
                    </div>
                @else
                    <p class="text-white-50">You are currently booking as a <strong>Guest</strong>.</p>
                @endif
            </div>
