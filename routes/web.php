...
Route::get('/customer-dashboard', [MainController::class, 'customerDashboard'])->middleware('customer.auth')->name('customerDashboard');
...
Route::get('/checkout/{id}', [App\Http\Controllers\MainController::class, 'showCheckout'])->name('showCheckout');
Route::post('/checkout-booking/{id}', [App\Http\Controllers\MainController::class, 'checkoutBooking'])->name('checkoutBooking');
